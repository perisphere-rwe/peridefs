...
`spec_diabetes_type2` is a
[CompositeDrugSpec](https://perisphere-rwe.github.io/peridefs/reference/CompositeDrugSpec.md)
containing all ten versioned antidiabetic leaf specs: `biguanide_v1`,
...
``` r
get_diabetes_type2_generics(component = NULL, priority = 1L, condition = NULL)

get_diabetes_type2_meds_labels(component = NULL)
```
